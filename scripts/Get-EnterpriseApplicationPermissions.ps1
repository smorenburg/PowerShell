    ...
    $principals | ForEach-Object {
        Get-AzureADServiceAppRoleAssignedTo -ObjectID $_.ObjectId -All:$true | Where-Object { $_.PrincipalType -eq "ServicePrincipal" } | ForEach-Object {
            ...
            $permissionDetails = [ordered]@{
                ...
                "PolicyScopeIdentity"  = $policy.ScopeIdentity
                "PolicyAccessRight"    = $policy.AccessRight
                "ConsentType"          = $null
        ...
        if ($grant.Scope) {
            $grant.Scope.Split(" ") | Where-Object { $_ } | ForEach-Object {
                ...
                $permissionDetails = [ordered]@{
                    ...
                    "Permission"           = $scope
                    "PolicyPresent"        = $null
                    "PolicyScopeIdentity"  = $null
                    "PolicyAccessRight"    = $null
...
Write-Output `n"Exported the permissions to: $OutputFile."